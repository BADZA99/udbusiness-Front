            ...
            <div className="bg-white shadow rounded-lg p-6">
              <div className="flex flex-col items-center">
                <img
                  src={
                    user.sexe === "femme"
                      ? "https://previews.123rf.com/images/tuktukdesign/tuktukdesign1608/tuktukdesign160800038/61010824-user-icon-woman-profile-businesswoman-avatar-person-glyph-vector-illustration.jpg"
